...
Trạng thái hiện tại của repo: **đã hoàn thành nền tảng Module 1-5, hoàn thiện Module 6.5, mở Module 7 mức tối thiểu, có hóa đơn + payment thủ công cho Module 8, đã mở Module 9 tối thiểu với công việc/thông báo nội bộ, đã có Module 10 chat 1-1 tối thiểu và Module 11 báo cáo demo tối thiểu**.
...
10. Trao đổi nội bộ 1-1 giữa các user có quyền chat.
...
- Socket realtime đầy đủ cho chat
...
- `TSK-DEMO-001` cho công việc nội bộ
- Notification in-app phát sinh từ task demo
- 1 conversation chat 1-1 giữa `manager` và `staff`
...
- Các module `Reports`, `Chat` đã mounted mức demo tối thiểu, nhưng chưa có realtime sâu, phân tích nâng cao hoặc object-level scope.
...
- README này được cập nhật theo trạng thái code hiện tại đến thời điểm đã có **Module 10 - Chat nội bộ tối thiểu** và **Module 11 - Báo cáo demo tối thiểu** cùng batch hardening sau automation review.
